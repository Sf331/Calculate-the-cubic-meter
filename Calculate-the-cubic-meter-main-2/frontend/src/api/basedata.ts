...
/**
 * 课型标记。tone 不是随手配的色：
 *   试听 = 新客，要跟；补课 / 代课 = 排课时的异常，要留意；跨校区 = 只是分类，不上色。
 * 扫一眼课表就知道哪些课需要额外处理，这才是颜色编码的意义。
 */
export const COURSE_TAG_OPTIONS = [
  { label: '试听课', value: 'TRIAL', tone: 'info' as const },
  { label: '补课', value: 'MAKEUP', tone: 'warning' as const },
  { label: '代课', value: 'SUBSTITUTE', tone: 'warning' as const },
  { label: '跨校区课', value: 'CROSS_CAMPUS', tone: 'neutral' as const }
]
